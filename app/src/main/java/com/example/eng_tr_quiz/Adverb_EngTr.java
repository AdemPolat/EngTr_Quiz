...
public class Adverb_EngTr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adverb__eng_tr);
        ...
        int StoredAdv1 = sharedPreferences.getInt("StoredAdv1", 0);
        int StoredAdv2 = sharedPreferences.getInt("StoredAdv2", 0);
        int StoredAdv3 = sharedPreferences.getInt("StoredAdv3", 0);
        textHigh1.setText(""+StoredAdv1);
        textHigh2.setText(""+StoredAdv2);
        textHigh3.setText(""+StoredAdv3);
        ...
        for(int i = 0; i< new Adverb_Database().turkish.length; i++){

            list.add(new Adverb_Item(new Adverb_Database().turkish[i],new Adverb_Database().english[i]));
        }
    ...
    public void gameOver(){
        ...
        if(puan >= hScore){
            ...
            sharedPreferences.edit().putInt("StoredAdv1",hScore).apply();
            sharedPreferences.edit().putInt("StoredAdv2",hScore2).apply();
            sharedPreferences.edit().putInt("StoredAdv3",hScore3).apply();
        ...
        uAdv1= textHigh1.getText().toString();  // GET INTENT
        uAdv2= textHigh2.getText().toString();
        uAdv3= textHigh3.getText().toString();
        Intent intent = new Intent(Adverb_EngTr.this, High_Score.class);
        intent.putExtra("userAdv1",uAdv1);
        intent.putExtra("userAdv2",uAdv2);
        intent.putExtra("userAdv3",uAdv3);



        myCountDownTimer.cancel();
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Adverb_EngTr.this);
        ...
        alertDialogBuilder.setPositiveButton("Yeni Oyun", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(getApplicationContext(), Adverb_EngTr.class));
                finish();
            }
        });
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(Adverb_EngTr.this);  // Uyarı mesajını açar
        ...
        alert.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                myCountDownTimer.cancel();
                Intent intent= new Intent(Adverb_EngTr.this, Quiz_Anasayfa.class);
