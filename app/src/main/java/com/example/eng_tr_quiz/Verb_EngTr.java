...
public class Verb_EngTr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.verb__eng_tr);
        ...
        int StoredVerb1 = sharedPreferences.getInt("StoredVerb1", 0);
        int StoredVerb2 = sharedPreferences.getInt("StoredVerb2", 0);
        int StoredVerb3 = sharedPreferences.getInt("StoredVerb3", 0);
        textHigh1.setText(""+StoredVerb1);
        textHigh2.setText(""+StoredVerb2);
        textHigh3.setText(""+StoredVerb3);
        ...
        for(int i = 0; i< new Verb_Database().turkish.length; i++){

            list.add(new Verb_Item(new Verb_Database().turkish[i],new Verb_Database().english[i]));
        }
    ...
    public void gameOver(){
        ...
        if(puan >= hScore){
            ...
            sharedPreferences.edit().putInt("StoredVerb1",hScore).apply();
            sharedPreferences.edit().putInt("StoredVerb2",hScore2).apply();
            sharedPreferences.edit().putInt("StoredVerb3",hScore3).apply();
        ...
        uVerb1= textHigh1.getText().toString();  // GET INTENT
        uVerb2= textHigh2.getText().toString();
        uVerb3= textHigh3.getText().toString();
        Intent intent = new Intent(Verb_EngTr.this, High_Score.class);
        intent.putExtra("userVerb1",uVerb1);
        intent.putExtra("userVerb2",uVerb2);
        intent.putExtra("userVerb3",uVerb3);




        myCountDownTimer.cancel();
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Verb_EngTr.this);
        ...
        alertDialogBuilder.setPositiveButton("Yeni Oyun", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(getApplicationContext(), Verb_EngTr.class));
                finish();
            }
        });
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(Verb_EngTr.this);  // Uyarı mesajını açar
        ...
        alert.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                myCountDownTimer.cancel();
                Intent intent= new Intent(Verb_EngTr.this, Quiz_Anasayfa.class);
